...
$con = mysqli_connect("localhost","root","DyariBoss060606","dyaribook") or die("Connection was not established");
...
<img src='users/$user_image' width='150px' height='140px' title='$username' style='float: right; margin:1px;' /> 
</a>
</div><br><br>
<div class='col-sm-6'>
