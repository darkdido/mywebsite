...
<input id="msg" name="recovery_account" type="text" class="form-control" placeholder="Someone" required>
</div><br>
<a title="signin" style="text-decoration: none; float: right; color: #187fab"; data-toggle="tooltip" href="signin.php">Back To Signin ?</a><br><br>
